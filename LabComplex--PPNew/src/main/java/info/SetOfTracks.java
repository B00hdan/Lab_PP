...
public class SetOfTracks {
    ...
    public boolean changeTrackParams(String[] params){
        ...
        if(trackList.stream().noneMatch(track -> track.getName().equals(newParamsSimple.get("name"))))
            return false;
    ...
    public boolean printTracksByDurationBorders(String[] params){
        ...
        if(!finalLess.equals("null") && !finalMore.equals("null")){
    ...
    protected Map<String, String> makeMapForParams(String[] params){
